...
class InterruptedActionConditionWidget extends StatefulWidget {
  ...
  const InterruptedActionConditionWidget(
  {super.key, required this.paramData});

  @override
  State<InterruptedActionConditionWidget> createState() =>
      _InterruptedActionConditionWidgetState();
}

class _InterruptedActionConditionWidgetState
    extends State<InterruptedActionConditionWidget> {
  @override
  void initState() {
    super.initState();
  }
